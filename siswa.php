        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="index.php" class="navbar-brand"> LAB KOMPUTER TKJ
              <small>SMK TERPADU AL-IKHWAN</small></a>
        ...
        <div class="container">
          ...
          <section class="content-header">
			<div class="box-header with-border">
              <h3 class="box-title">Login sebagai : <i><?php echo $_SESSION['nama']; ?><h3 class="box-title"></i></h3>
              <div class="box-tools pull-right">
                <a href="logout.php" role="button"class="btn btn-danger btn-flat">Logout</a>
              </div>
            </div>
